      ...
      body: Form(
        ...
        child: ListView(
          children: [
            ...
            esEditar
                ...
                : Column(
                    children: [
                      ...
                      InputLogin(
                        texto: 'Confirmacion de Contraseña',
                        controller: confirmContrasController,
                        esContrasena: true,
                      ),
                    ],
                  ),
            ...
            esEditar && loginController.usuario.value.tipoUsuario == 3
                ? Padding(
                    ...
                    onPressed: () async {
                      if (_keyFrom.currentState!.validate()) {
                        if (!cedulaController.text.isNum) {
                          Get.snackbar('Error', 'La cedula es numerica',
                        ...
                        if (!esEditar) {
                          if (contrasController.text.isEmpty ||
                              confirmContrasController.text.isEmpty) {
                            Get.snackbar(
                                'Error', 'Todos los datos son obligatorios',
                                snackPosition: SnackPosition.BOTTOM);
                            return;
                          }
                          if (contrasController.text !=
                              confirmContrasController.text) {
                            Get.snackbar(
                        ...
                        if (esEditar) {
                          ...
                          bool response = await usuarioController
                              .actualizarUsuario(tempUsuario);
                          if (response) {
                            Get.snackbar(
                                'Actualizado', 'Se actualizó correctamente',
                                snackPosition: SnackPosition.BOTTOM);
                          } else {
                            Get.snackbar('Error',
                          ...
                          Usuario? usuRes =
                              await loginController.registraEmail(tempUsuario);
                          if (usuRes != null) {
                            Get.snackbar('Creado', 'Se creo correctamente',
                                snackPosition: SnackPosition.BOTTOM);
                          } else {
                            Get.snackbar('Error',
